(function() {
  ...
  Spook = (function() {
    ...
    Spook.prototype.paste = function(message) {
    ...
    Spook.prototype.connect = function() {
      ...
      return this.connection.room(this.roomID, __bind(function(err, room) {
        this.room = room;
    ...
    Spook.prototype._processMessage = function(err, message) {
